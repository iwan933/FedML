...
from fedml_api.distributed.fed_transformer.FedAVGAggregator import FedAVGAggregator
from fedml_api.distributed.fed_transformer.FedAVGTrainer import FedAVGTrainer
from fedml_api.distributed.fed_transformer.FedAvgClientManager import FedAVGClientManager
from fedml_api.distributed.fed_transformer.FedAvgServerManager import FedAVGServerManager
...
def FedML_Fed_Transformer_distributed(process_id, worker_number, device, comm, model, train_data_num, train_data_global, test_data_global,
